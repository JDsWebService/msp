        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 text-center">
                    <a href="{{ $image->original->publicPath }}" target="_blank">
                        <img src="{{ $image->preview->publicPath }}" class="portfolio-single-image" alt="{!! $image->title !!}">
                    </a>
                </div>
                <div class="col-md-4">
                    <div class="project-details mt-0">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ $image->original->publicPath }}" target="_blank"><i class="far fa-eye"></i> View Full Image</a>
                            </li>
                        </ul>
                    </div>
                </div>
